...
public class ControleAvatar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Rotation des mains
        AvatarMainDroite.rotation = Quaternion.Lerp(AvatarMainDroite.rotation, Quaternion.Euler(new Vector3(XRRightHand.rotation.eulerAngles.x + 90f, XRRightHand.rotation.eulerAngles.y, XRRightHand.rotation.eulerAngles.z)), 0.5f);
        AvatarMainGauche.rotation = Quaternion.Lerp(AvatarMainGauche.rotation, Quaternion.Euler(new Vector3(XRLeftHand.rotation.eulerAngles.x + 90f, XRLeftHand.rotation.eulerAngles.y, XRLeftHand.rotation.eulerAngles.z)), 0.5f);
    }
}
